<form action="{{ route('extra-pages.ajax-store-item', $category['id']) }}" method="post" class="w-100 mx-auto"
  enctype="multipart/form-data" id="form-add-item">
  @csrf
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-sm col-lg-4 col-md-4 mb-3">
        <input type="text" name="second_text" id="second_text" class="form-control" placeholder="Kalimat Pelengkap"
          maxlength="30" required>
      </div>
    </div>
    <div class="row">
      <div class="col-sm col-lg-6 col-md-6 mb-3">
        <input type="text" name="country" id="country" class="form-control" placeholder="Negara..." max="100"
          required>
      </div>
      <div class="col-sm col-lg-6 col-md-6 mb-3">
        <input type="text" name="region" id="region" class="form-control" placeholder="Daerah.." max="100"
          required>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="seo_title" id="seo_title"
            placeholder="Judul untuk seo (minimal 5 kali disebutkan di artikel dan dibold)" maxlength="255" required>
        </div>
      </div>
    </div>
    <div class="form-group">
