                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input @error('logo_about') is-invalid @enderror"
                        name="logo_about" id="thumnail-01" accept="image/*" name="logo_about" required>
                      <label class="custom-file-label text-muted" for="thumnail-01">Logo utama halaman about</label>
                    </div>
                  </div>
                </div>
                <div class="form-group mb-3">
                  <div class="input-group">
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label text-muted" for="thumnail-01">Logo header setiap halaman</label>
                    </div>
                  </div>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-sm col-lg-6 col-md-6 mb-3">
                    <input type="text" name="kelurahan"
                      class="form-control @error('kelurahan') is-invalid @enderror" placeholder="Kelurahan" required>
                    @error('kelurahan')
                      <span class="error invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm col-lg-4 col-md-4 mb-3">
                        <input type="text" name="provinsi"
                          class="form-control @error('provinsi') is-invalid @enderror" placeholder="Provinsi" required>
                        @error('provinsi')
                          <span class="error invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                          </span>
