  ...
  <div class="container">
    <div class="row mt-2 pt-2">
      <div class="col-sm-12 col-md-8 col-lg-8 p-2">
        <div class="card">
          <div class="mb-0 px-4 pt-4">
            <h3 class="py-0 my-0">Mame Tirta Dewata Wisata {{ ucwords($subcategory['subcategory']) }}</h3>
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-start mb-2">
              ...
              <div class="px-2 py-1 destinasi">
                <h5 class="py-0" style="text-transform: none; color: orange">{{ strtoupper($subcategory['country']) }}
                </h5>
                <span>Wilayah:</span> <b class="text-info">{{ ucwords($subcategory['region']) }}</b>
              </div>
            </div>
            <div class="mb-4">
              <img src="{{ asset('images/extra/' . $subcategory['image']) }}" alt="{{ $subcategory['image'] }}"
                class="img_inner my-0">
            </div>
      ...
      <div class="col-sm-12 col-md-4 col-lg-4 p-2">
        <div class="card p-3">
          <div class="mb-5">
            <h3 class="text-center py-0 mb-0 mt-2">Tersedia Paket</h3>
          </div>
          @if (count($packages) > 0)
                ...
                <div class="card-body p-4">
                  <h5 class="card-title text-center text-info mb-3">{{ strtoupper($package['package_name']) }}</h5>
									<div class="text-center">
										<img src="{{ asset('images/extra/' . $package['thumbnail']) }}" alt="{{ $package['thumbnail'] }}" class="img-thumbnail">
									</div>
            ...
            <div class="card m-2 std-shadow"
              ...
              <div class="text-center mt-4 pt-5">
                <div class="pb-4 text-shadow" style="color: #ff7300; font-size: 1.9rem">
                  {{ strtoupper($sugest['travel_name']) }}</div>
